...
- 📝 [doctor Command](tools/doctor.md)
- 📝 [install Command](tools/install.md)
- 📝 [Tool Logging and Output Semantics](tools/logging.md)
- 📝 [run and stop Commands](tools/run-stop.md)
- 📝 [test Command](tools/test.md)
