...
describe("follow-up ui rendering", () => {
  ...
  it("renders the self employment dashboard as an independent page", () => {
    ...
    expect(selfEmploymentFeatureSource).toContain("self-employment-project-list-modules");
    expect(selfEmploymentFeatureSource).toContain("self-employment-project-module-grid");
    expect(selfEmploymentFeatureSource).toContain("self-employment-toggle-dashboard-project");
    expect(selfEmploymentFeatureSource).toContain('data-self-employment-field="${escapeHtml(`module.${module}`)}"');
