...
import type { IncomePlanningSlot } from "../../types";
...
import { renderIncomePlanningStampMenu, renderIncomePlanningStampPicker } from "./stampPopupController";
import {
...
import {
  defaultIncomePlanningSlot,
  isIncomePlanningWeekday,
  removeIncomePlanningSlot,
  updateIncomePlanningOwnerSlots
} from "./planningSanitizer";
import { renderIncomePlanning, renderIncomePlanningHabitIconPicker } from "./controller";
...
export function updateIncomePlanningDialogScenarioSelection(scenarioId: string, checked: boolean): void {
...
export function updateIncomePlanningDialogSleepSlotGroup(groupId: string, field: keyof IncomePlanningSleepSlotGroup, value: string): void {
  if (!incomePlanningUiState.dialog || incomePlanningUiState.dialog.ownerType !== "assumption" || !groupId) return;
  incomePlanningUiState.dialog = {
    ...incomePlanningUiState.dialog,
...
export function updateIncomePlanningDialogSleepSlotGroupScenario(groupId: string, scenarioId: string, checked: boolean): void {
